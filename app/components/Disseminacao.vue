  ...
  <Page class="page">
        <ActionBar class="action-bar">
            ...
            <ActionItem icon="res://menu"
                        ...
                        ios.position="left"/>
            <Label class="action-bar-title" text="Disseminação"/>
        </ActionBar>
    ...
    <StackLayout @tap="onNavigationItemTap(Home)">
      ...
      <ScrollView orientation="vertical">
        ...
        <Label class="p-l-15 p-b-10 m-r-20 m-t-10"
          ...
          textWrap="true">
            <FormattedString>
            <Span text="Os nematoides são disseminados por calçados e maquinários contaminados,  enxurrada, irrigação, mudas, sementes e vento." ></Span>
            </FormattedString>
        </Label>
