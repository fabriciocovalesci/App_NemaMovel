  ...
  <Page class="page">
        <ActionBar class="action-bar">
            ...
            <ActionItem icon="res://menu"
                        ...
                        ios.position="left"/>
            <Label class="action-bar-title" text="Nematóides"/>
        </ActionBar>
    ...
    <StackLayout @tap="onNavigationItemTap(Home)">
      <FlexboxLayout class="m-5 p-10" justifyContent="space-between"  flexDirection="column" height="100%">
        ...
        <Label class="textStyle"
          ...
          textWrap="true">
            <FormattedString>
            <Span class="textStyle" text="Verme microscópico em formato cilíndrico alongado que parasita plantas, causando um distúrbio fisiológico, deixando a planta doente." ></Span>
            </FormattedString>
        </Label>
        <Image src="~/assets/images/nematoides.jpeg" class="m-10" height="500"  stretch="Fill"/>
